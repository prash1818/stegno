...
public class LoginDataBaseAdapter {
	...
	static final String DATABASE_CREATE = "create table "+"LOGIN"+
			"( " +"ID integer primary key autoincrement,"+"USERNAME  text,"+ "PASSWORD  text,"+"REPASSWORD text,"+"MOBILE text,"+ "SECURITYHINT text,"+"SECURITYHINT1 text)";
	...
	public void insertEntry(String username,String password,String repassword,String mobile,String securityhint,String securityhint1)
	{
