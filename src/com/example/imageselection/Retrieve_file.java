...
public class Retrieve_file extends Activity {
    				...
    				alertDialogBuilder
    						...
    						.setPositiveButton("OK", new DialogInterface.OnClickListener() {
    									public void onClick(DialogInterface dialog, int id) {
    										...
    										Boolean k=true;
    										//s="1234567890";
    										Boolean message= Steganograph.retrieveFile(steg, s,k);
    										String s1 = Boolean.toString(message);
    										Log.i("Status1",s1);
    										Log.i("Status",message.toString());
